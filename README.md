...
- 簡単に自己紹介
  ...
  新卒で通信事業者に入社し，デジタルマーケティング基盤の導入構築を担当するSEとして従事．データ分析で課題解決したい思いが高まり2年弱で退職し，機械学習を用いた異常検知ソリューションを提供するベンチャーに転職．製造業のクライアントに対するデータ分析や自社の機械学習プロダクト開発を担当した後，toC向けのアプリを開発している会社にてレコメンドシステム・検索システムの導入，MLOpsの推進を担当した後，1人目の機械学習エンジニアとして，2023年4月に3回目の転職をし，現在に至る．
